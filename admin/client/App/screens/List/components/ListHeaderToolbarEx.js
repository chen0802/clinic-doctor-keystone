...
function ListHeaderToolbarEx ({
	...
	//display or hiden components
	displayConfig,
	// model.options.searchFieldsPlaceHolder
	...
	return (
		<Group block cssStyles={classes.wrapper}>
			...
			<Section grow cssStyles={classes.buttons}>
				<Group block>
					{displayConfig.filters && <Section cssStyles={classes.filter}>
						<ListFiltersAdd
							dispatch={dispatch}
					...
					{displayConfig.columns && <Section cssStyles={classes.columns}>
						<ListColumnsForm
					...
					{ displayConfig.options && <Section cssStyles={classes.columns}>
						<ListOptionsForm
							availableOptions={optionsAvailable}
							activeOptions={optionsActive}
 							dispatch={dispatch}
 						/>
 					</Section>}
...
ListHeaderToolbarEx.propTypes = {
	...
	optionsActive: PropTypes.array,
	optionsAvailable: PropTypes.array
};
...
module.exports = ListHeaderToolbarEx;
