...
import { columnsParser, sortParser, filtersParser
	////ADDON:OPTIONS
	,optionsParser 
} from '../parsers';
...
export function * updateParams () {
	...
	////ADDON:OPTIONS
	let options = activeState.options;
...
export function parseQueryParams (query, currentList) {
	...
	////ADDON:OPTIONS
	const options = optionsParser(query.options)||''; // optionsParser(query.options, currentList);
	return {
		columns,
		sort,
		filters,
