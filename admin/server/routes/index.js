...
module.exports = function IndexRoute (req, res) {
	...
	var keystoneData = {
		...
		//: additional global keystone parameters
		socket_cluster_options: keystone.get("socket cluster options"),
		appname: keystone.get('appname'),
		brandUrl: keystone.get('brand url'),
		mobileSiteUrl: keystone.get('mobile site url'),
		//.
	};
